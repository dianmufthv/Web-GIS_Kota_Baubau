...
var style_ADMINISTRASIKECAMATAN_AR_50K_1 = function(feature, resolution){
    ...
    if (value >= 0.000150 && value <= 0.001582) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.001582 && value <= 0.002628) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.002628 && value <= 0.007333) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.007333 && value <= 0.016928) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.016928 && value <= 0.038562) {
            style = [ new ol.style.Style({
