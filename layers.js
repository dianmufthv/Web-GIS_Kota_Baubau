...
//ol.proj.get("EPSG:4326").setExtent([122.186761, -5.738589, 123.263854, -5.095785]);
var wms_layers = [];
...
var lyr_ADMINISTRASIKECAMATAN_AR_50K_1 = new ol.layer.Vector({
    ...
    <img src="styles/legend/ADMINISTRASIKECAMATAN_AR_50K_1_0.png" /> 0,0001 - 0,0016<br />\
    <img src="styles/legend/ADMINISTRASIKECAMATAN_AR_50K_1_1.png" /> 0,0016 - 0,0026<br />\
    <img src="styles/legend/ADMINISTRASIKECAMATAN_AR_50K_1_2.png" /> 0,0026 - 0,0073<br />\
    <img src="styles/legend/ADMINISTRASIKECAMATAN_AR_50K_1_3.png" /> 0,0073 - 0,0169<br />\
    <img src="styles/legend/ADMINISTRASIKECAMATAN_AR_50K_1_4.png" /> 0,0169 - 0,0386<br />' });
...
var lyr_JALAN_LN_50K_3 = new ol.layer.Vector({
    ...
    <img src="styles/legend/JALAN_LN_50K_3_0.png" /> Jalan Kolektor<br />\
    <img src="styles/legend/JALAN_LN_50K_3_1.png" /> Jalan Lain<br />\
    <img src="styles/legend/JALAN_LN_50K_3_2.png" /> Jalan Lokal<br />\
    <img src="styles/legend/JALAN_LN_50K_3_3.png" /> Jalan Setapak<br />\
    <img src="styles/legend/JALAN_LN_50K_3_4.png" /> <br />' });
var format_PUSKESMAS_PT_50K_4 = new ol.format.GeoJSON();
var features_PUSKESMAS_PT_50K_4 = format_PUSKESMAS_PT_50K_4.readFeatures(json_PUSKESMAS_PT_50K_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_PUSKESMAS_PT_50K_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_PUSKESMAS_PT_50K_4.addFeatures(features_PUSKESMAS_PT_50K_4);
var lyr_PUSKESMAS_PT_50K_4 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_PUSKESMAS_PT_50K_4, 
                style: style_PUSKESMAS_PT_50K_4,
                popuplayertitle: 'PUSKESMAS_PT_50K',
                interactive: true,
                title: '<img src="styles/legend/PUSKESMAS_PT_50K_4.png" /> PUSKESMAS_PT_50K'
            });

lyr_GoogleSatellite_0.setVisible(true);lyr_ADMINISTRASIKECAMATAN_AR_50K_1.setVisible(true);lyr_ADMINISTRASIKECAMATAN_LN_50K_2.setVisible(true);lyr_JALAN_LN_50K_3.setVisible(true);lyr_PUSKESMAS_PT_50K_4.setVisible(true);
var layersList = [lyr_GoogleSatellite_0,lyr_ADMINISTRASIKECAMATAN_AR_50K_1,lyr_ADMINISTRASIKECAMATAN_LN_50K_2,lyr_JALAN_LN_50K_3,lyr_PUSKESMAS_PT_50K_4];
...
lyr_PUSKESMAS_PT_50K_4.set('fieldAliases', {'NAMOBJ': 'NAMOBJ', 'FCODE': 'FCODE', 'LCODE': 'LCODE', 'SRS_ID': 'SRS_ID', 'REMARK': 'REMARK', 'METADATA': 'METADATA', 'KWKPKM_': 'KWKPKM_', 'KMPPKM_': 'KMPPKM_', 'JPLPKM_': 'JPLPKM_', 'PKMKODE_': 'PKMKODE_', 'PKMKAT_': 'PKMKAT_', 'PKMLMT_': 'PKMLMT_', });
...
lyr_PUSKESMAS_PT_50K_4.set('fieldImages', {'NAMOBJ': 'TextEdit', 'FCODE': 'TextEdit', 'LCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'REMARK': 'TextEdit', 'METADATA': 'TextEdit', 'KWKPKM_': 'TextEdit', 'KMPPKM_': 'TextEdit', 'JPLPKM_': 'TextEdit', 'PKMKODE_': 'TextEdit', 'PKMKAT_': 'TextEdit', 'PKMLMT_': 'TextEdit', });
...
lyr_PUSKESMAS_PT_50K_4.set('fieldLabels', {'NAMOBJ': 'no label', 'FCODE': 'no label', 'LCODE': 'no label', 'SRS_ID': 'no label', 'REMARK': 'no label', 'METADATA': 'no label', 'KWKPKM_': 'no label', 'KMPPKM_': 'no label', 'JPLPKM_': 'no label', 'PKMKODE_': 'no label', 'PKMKAT_': 'no label', 'PKMLMT_': 'no label', });
lyr_PUSKESMAS_PT_50K_4.on('precompose', function(evt) {
